...
const AREAS: SectionCard[] = [
  ...
  {
    href: '/finance/impuestos',
    label: 'Impuestos',
    description: 'Las tarifas vigentes y la declaración de IVA de cada mes, calculada del mayor.',
    icon: PercentIcon,
    action: 'view:finance',
  },
  {
    ...
    description: 'Qué le falta a cada mes para cerrarse, y qué meses ya no aceptan asientos.',
    icon: CalendarCheckIcon,
    action: 'view:finance',
  },
  {
    href: '/finance/paquete-contador',
    label: 'Paquete del contador',
    description: 'El juego contable completo del mes en PDF y CSV, versionado y listo para mandar.',
    icon: PackageIcon,
    action: 'view:finance',
  },
  {
